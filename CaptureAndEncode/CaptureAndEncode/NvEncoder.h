...
public:
    ...
    */
    ...
    void EncodeFrame(std::vector<NvEncOutputFrame> &frames, NV_ENC_PIC_PARAMS *pPicParams = nullptr);
...
private:
    ...
    */
    ...
    void GetEncodedPacket(std::vector<NV_ENC_OUTPUT_PTR> &vOutputBuffer, std::vector<NvEncOutputFrame> &frames, bool bOutputDelay);
